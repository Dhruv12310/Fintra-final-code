...
export default function Sidebar() {
  ...
  return (
    <aside
      className="w-60 h-screen fixed left-0 top-0 overflow-y-auto flex flex-col"
    ...
    >
      <div className="p-6" style={{ borderBottom: '1px solid var(--border-color)' }}>
        <div className="flex items-center gap-2">
          ...
          <div>
            <h1 className="text-lg font-bold" style={{ color: 'var(--text-primary)' }}>MiniBooks</h1>
            <p className="text-xs" style={{ color: 'var(--text-muted)' }}>AI Companion</p>
          </div>
        </div>
      </div>
