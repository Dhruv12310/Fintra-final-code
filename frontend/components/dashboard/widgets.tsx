...
import {
  ArrowUpRight, BarChart2, TrendingUp, CreditCard, Clock,
  Zap, List, AlertCircle, CheckCircle2, Droplets, FileText,
  Receipt, Building2, DollarSign, TrendingDown, LineChart,
  Sparkles, Bell, Loader2,
} from 'lucide-react'
...
export const WIDGET_CATALOG: WidgetCatalogEntry[] = [
  { widget_id: 'revenue_vs_expenses',   name: 'Revenue vs Expenses',    description: 'Monthly revenue and expenses bar chart for last 12 months',     chartType: 'Grouped Bar',    defaultVisible: true,  icon: BarChart2 },
  { widget_id: 'profit_margin_trend',   name: 'Profit Margin Trend',    description: 'Net profit margin % trend over 12 months',                      chartType: 'Area Line',      defaultVisible: true,  icon: TrendingUp },
  { widget_id: 'top_expense_categories',name: 'Top Expense Categories', description: 'Ranked horizontal bars of your top expenses this period',        chartType: 'Horizontal Bar', defaultVisible: true,  icon: CreditCard },
  { widget_id: 'receivables_aging',     name: 'Receivables Aging',      description: 'Outstanding AR broken down by aging buckets',                   chartType: 'Progress Bars',  defaultVisible: true,  icon: Clock },
  { widget_id: 'action_items',          name: 'Action Items',           description: 'Alerts for overdue invoices, upcoming bills, and draft entries', chartType: 'List',           defaultVisible: true,  icon: Zap },
  { widget_id: 'recent_transactions',   name: 'Recent Transactions',    description: 'Last 10 journal entries with status',                           chartType: 'Table',          defaultVisible: true,  icon: List },
  { widget_id: 'accounts_payable',      name: 'Accounts Payable',       description: 'AP aging breakdown as a donut chart',                           chartType: 'Donut Chart',    defaultVisible: false, icon: AlertCircle },
  { widget_id: 'accounts_receivable',   name: 'Accounts Receivable',    description: 'Top 5 customers with outstanding balances',                     chartType: 'Bar Chart',      defaultVisible: false, icon: CheckCircle2 },
  { widget_id: 'cash_flow',             name: 'Cash Flow',              description: 'Monthly inflows vs outflows for last 6 months',                 chartType: 'Stepped Line',   defaultVisible: false, icon: Droplets },
  { widget_id: 'invoices',              name: 'Invoices',               description: 'Invoice status breakdown — Draft, Sent, Overdue, Paid',         chartType: 'Stacked Bar',    defaultVisible: false, icon: FileText },
  { widget_id: 'bills',                 name: 'Bills',                  description: 'Bills by status with count and total amount',                   chartType: 'List',           defaultVisible: false, icon: Receipt },
  { widget_id: 'deposits',              name: 'Deposits',               description: 'Monthly deposit amounts for last 6 months',                     chartType: 'Bar Chart',      defaultVisible: false, icon: Building2 },
  { widget_id: 'expenses',              name: 'Expenses',               description: 'Expense breakdown by category',                                 chartType: 'Bar Chart',      defaultVisible: false, icon: DollarSign },
  { widget_id: 'profit_and_loss',       name: 'Profit & Loss',          description: 'Revenue vs expenses for the selected period',                   chartType: 'Dual Bar',       defaultVisible: false, icon: TrendingDown },
  { widget_id: 'sales',                 name: 'Sales',                  description: 'Revenue trend over last 12 months',                             chartType: 'Line Chart',     defaultVisible: false, icon: LineChart },
  { widget_id: 'ai_analysis',           name: 'AI Analysis',            description: 'AI-generated financial insights and recommendations',           chartType: 'Text Card',      defaultVisible: false, icon: Sparkles },
  { widget_id: 'sentinel_alerts',       name: 'Sentinel Alerts',        description: 'Proactive GL intelligence — duplicate bills, anomalies, overdue AR', chartType: 'List',    defaultVisible: true,  icon: Bell },
]
