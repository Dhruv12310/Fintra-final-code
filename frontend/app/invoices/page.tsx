  ...
  return (
    <div className="min-h-screen p-6 space-y-6">
      ...
      <PageHeader
        ...
        title="Invoices"
        subtitle="Send invoices and track what customers owe you"
        actions={!showForm && (
        ...
        <div className="panel overflow-hidden" style={{ backgroundColor: 'var(--bg-card)', border: '1px solid var(--border-color)' }}>
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-2">
                  <select
                    ...
                    style={{ fontWeight: customerId ? '600' : '400' }}
                  >
                ...
                {customerId && (
                  <>
                    <input type="email" className="input" placeholder="Enter customer email"
                    ...
                    <div>
                      ...
                      <textarea rows={3} className="input" className="textarea" style={{ resize: 'none' }}
                    ...
                    <div>
                      ...
                      <textarea rows={2} className="input" className="textarea" style={{ resize: 'none' }}
                ...
                {[
                  {
                    label: 'Invoice no.',
                    node: (
                      <input className="input"style={{ color: 'var(--text-muted)' }}
                  ...
                  },
                  {
                    label: 'Terms',
                    node: (
                      <select className="input" value={terms} onChange={e => handleTermsChange(e.target.value)}>
              ...
              {lines.map(line => (
                <div key={line.key}>
                  ...
                  >
                    ...
                    {/* Product/service */}
                    <input className="input" placeholder="Product or service"
                    ...
                    {/* Qty */}
                    <input type="number" min="1" step="1" className="input text-right"
                      value={line.quantity}
          ...
          <div className="grid grid-cols-2" style={{ borderBottom: '1px solid var(--border-color)' }}>
            ...
            <div className="px-8 py-6" style={{ borderRight: '1px solid var(--border-color)' }}>
              ...
              <textarea rows={3} className="input" className="textarea" style={{ resize: 'none', marginTop: '8px' }}
      ...
      {!showForm && invoices.length > 0 && (
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
          {[
            ...
            { label: 'Avg Invoice Value', value: summaryStats.avg, icon: BarChart2, color: 'var(--text-secondary)' },
          ].map(stat => (
              ...
              >
                ...
                {count > 0 && (
                  <span className="ml-1.5 px-1.5 py-0.5 rounded-full text-xs font-semibold"
                    style={{
                      backgroundColor: active ? 'var(--accent-subtle)' : 'rgba(255,255,255,0.06)',
                ...
                <div className="flex items-center gap-1">
                  ...
                  {Array.from({ length: Math.min(pageCount, 7) }, (_, i) => i + 1).map(p => (
                    <button key={p} onClick={() => setPage(p)}
                      ...
                      style={{
                        backgroundColor: page === p ? 'var(--accent-subtle)' : 'var(--bg-primary)',
                        color: page === p ? 'var(--accent)' : 'var(--text-secondary)',
                        border: page === p ? '1px solid var(--accent)' : '1px solid var(--border-color)',
                      }}>
                      {p}
                    </button>
                  ))}
      ...
      {payModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4"
          ...
          <div className="w-full max-w-md panel" style={{ backgroundColor: 'var(--bg-card)', border: '1px solid var(--border-color)' }}>
            ...
            <div className="px-6 py-5 space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="number" min="0.01" step="0.01" className="input pl-7"
              ...
              <div>
                ...
                <select className="input" value={payForm.depositAccountId} onChange={e => setPayForm(f => ({ ...f, depositAccountId: e.target.value }))}>
                  <option value="">Select account…</option>
              ...
              <div>
                ...
                <input className="input" placeholder="Reference # or note" value={payForm.memo} onChange={e => setPayForm(f => ({ ...f, memo: e.target.value }))} />
              </div>
            </div>
