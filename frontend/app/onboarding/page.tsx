...
import { ArrowRight, ArrowLeft, CheckCircle2, Sun, Moon, Loader2, BarChart3, FileText, Sparkles, FolderTree } from 'lucide-react'
...
export default function OnboardingPage() {
  ...
  const Label = ({ text, required }: { text: string; required?: boolean }) => (
    <label className="label">
      {text}{required && <span style={{ color: 'var(--neon-red)' }} className="ml-0.5">*</span>}
    </label>
  )
  ...
  return (
    <div data-glow-zone="true" className="min-h-screen dot-grid flex items-center justify-center p-4 relative" style={{ backgroundColor: 'var(--bg-primary)' }}>

      {/* Neon glows */}
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        <div className="absolute -top-32 left-1/4 h-96 w-96 rounded-full blur-[200px]"
          style={{ backgroundColor: 'var(--accent)', opacity: 'var(--glow-opacity)' }} />
      ...
      {/* Theme toggle */}
      <button onClick={toggleTheme} className="btn btn-icon fixed top-4 right-4 z-50">
        {theme === 'dark'
      ...
      {/* Card */}
      <div className="max-w-xl w-full card p-8 md:p-10 relative z-10"
        style={{
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="col-span-2">
                    ...
                    <input className="input" placeholder="123 Main St Ste 100"
                      value={form.address} onChange={e => set('address', e.target.value)} />
                  </div>
                  <div>
                    <Label text="City" />
                    <input className="input" placeholder="Columbus"
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <div>
                      <Label text="ZIP" />
                      <input className="input" placeholder="43207"
          ...
          <div className="text-center space-y-6 py-4">
            <div className="flex justify-center">
              <div className="p-5 rounded-full"
                style={{ background: 'var(--accent)', boxShadow: '0 0 40px rgba(37,99,235,0.3)' }}>
            ...
            <div className="grid grid-cols-2 gap-3 text-left">
              {[
                { icon: BarChart3, t: 'Financial Reports',  d: 'P&L, Balance Sheet, Cash Flow'   },
                { icon: FileText,  t: 'Invoices & Bills',   d: 'AR / AP with auto-journal'        },
                { icon: Sparkles,  t: 'AI Insights',         d: 'Powered by your business data'   },
                { icon: FolderTree,t: 'Chart of Accounts',   d: 'Pre-built for your industry'     },
              ].map(f => (
                <div key={f.t} className="p-4 rounded-xl"
                  style={{ backgroundColor: 'var(--bg-primary)', border: '1px solid var(--border-color)' }}>
                  <f.icon className="w-4 h-4 mb-2" style={{ color: 'var(--accent)' }} />
            ...
            <button onClick={finish} disabled={loading}
              className="btn btn-primary btn-block flex items-center justify-center gap-2 disabled:opacity-50">
              {loading
